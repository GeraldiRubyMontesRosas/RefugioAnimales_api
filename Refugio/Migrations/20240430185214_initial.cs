...
namespace Refugio.Migrations
{
    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Descripcion = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Vacunas = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Mascotas_Generos_GeneroId",
                        column: x => x.GeneroId,
                        principalTable: "Generos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Mascotas_Tamaños_TamañoId",
                        column: x => x.TamañoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Mascotas_GeneroId",
                table: "Mascotas",
                column: "GeneroId");

            migrationBuilder.CreateIndex(
                name: "IX_Mascotas_TamañoId",
                table: "Mascotas",
                column: "TamañoId");
        }
